        ...
        <Card className="w-full max-w-md mx-4 bg-secondary/50 border-primary relative z-10 animate-fade-in">
          <CardContent className="p-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-foreground">You've been entered into the draw!</p>
            </div>
        ...
        <CardHeader className="text-center space-y-4">
          <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto ${
            ...
            {won ? (
              ...
              <svg className="w-8 h-8 text-danger-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="text-foreground">
              {won 
                ? `You scored ${score} point${score !== 1 ? 's' : ''}! Enter the prize draw below.`
